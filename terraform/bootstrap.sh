...
DOMAIN=status.tarkov.dev # the domain to serve traffic with
REPO_DIR=/home/status/status # the repo to clone and use for the app deployment
VM_USER=status # the name of the vm user
...
# clone the repo
git clone https://github.com/the-hideout/status.git $REPO_DIR
